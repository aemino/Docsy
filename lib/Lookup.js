...
class Lookup {
  ...
  generateMember(docsMember) {
    const parent = docsMember.parent.directData.name;
    const { name, description } = docsMember.directData;
  ...
  generateFunction(docsFunction) {
    const parent = docsFunction.parent.directData.name;
    const { name, description } = docsFunction.directData;
  ...
  generateEvent(docsEvent) {
    const parent = docsEvent.parent.directData.name;
